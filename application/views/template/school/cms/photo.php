<div class="body">
  <div class="page_navi">您的位置：<a href="<?php echo base_url();?>">首页</a><?php echo $this->cms_function->get_current_path($index['class_id'],'photo');?> &gt; <?php echo $index['cms_title']?></div>
  <div class="page_div" id="cms_photo" >
