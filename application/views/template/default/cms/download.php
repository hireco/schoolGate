<div class="body">
  <div class="page_navi">您的位置：<a href="<?php echo base_url();?>">首页</a> &gt;  <a href="<?php echo site_url('cms');?>">新闻信息 </a><?php echo $this->cms_function->get_current_path($index['class_id'],'video');?> &gt; <?php echo $index['cms_title']?></div>
